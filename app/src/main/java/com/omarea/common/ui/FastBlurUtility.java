...
public class FastBlurUtility {
    ...
    /**
     * Chụp màn hình và làm mờ an toàn
     */
    ...
    public static Bitmap startBlurBackground(Bitmap bkg) {
        ...
        // ĐÃ SỬA LỖI LEAK: Giải phóng smallBitmap nếu nó khác với blurred
        ...
        // 3. Phóng to & áp dụng Dim (scaleAndDim đã tự recycle 'blurred' ở bên trong)
    ...
    private static Bitmap scaleAndDim(Bitmap bitmap, int targetW, int targetH) {
        ...
        // Giải phóng bitmap tạm sau khi vẽ
    ...
    /**
     * Thuật toán StackBlur (Multi-pass box blur)
     */
    private static Bitmap fastBlur(Bitmap sentBitmap, int radius) {
        if (sentBitmap == null || sentBitmap.isRecycled()) return null;

        // ĐÃ SỬA LỖI CRASH: Kiểm tra Config an toàn, tránh NullPointerException
